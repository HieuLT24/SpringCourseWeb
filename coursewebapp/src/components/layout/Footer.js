      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4 mb-4">
            ...
            <p className="text-muted">Nền tảng học trực tuyến hàng đầu, cung cấp các khóa học chất lượng cao từ những chuyên gia hàng đầu.</p>
            <div className="d-flex gap-3">
              ...
              <a href="#" className="text-light fs-5"><i className="fab fa-linkedin"></i></a>
          ...
          <div className="col-lg-4 mb-4">
            ...
            <p className="text-muted">Nhận thông tin về các khóa học mới và ưu đãi đặc biệt.</p>
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <p className="mb-0 text-muted">&copy; 2025 CourseWeb. Tất cả quyền được bảo lưu.</p>
          </div>
